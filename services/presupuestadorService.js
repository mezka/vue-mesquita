...
var cartFormatter = {
    formatCart(cartArr) {
        cartArr.forEach(function (cartObj) {
            if (cartObj.productselectedaccessories && cartObj.productselectedaccessories.length) {
                cartObj.productselectedaccessories = cartObj.productselectedaccessories.filter(accObj => !isEmptyObject(accObj));
            }
        })

        return cartArr.filter(cartObj => !isEmptyObject(cartObj));
    }
};
